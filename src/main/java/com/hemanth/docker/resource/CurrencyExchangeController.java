...
import com.hemanth.docker.containerservice.ContainerMetaDataService;
...
public class CurrencyExchangeController {
	...
	public ExchangeVal retrieveExchangeValue(@PathVariable String from, @PathVariable String to,
			@RequestHeader Map<String, String> headers) {

		printAllHeaders(headers);

		ExchangeVal exchangeValue = repository.findByFromAndTo(from, to);
